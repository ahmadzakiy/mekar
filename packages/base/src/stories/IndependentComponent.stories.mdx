...
<Meta title="Independent Component" />

# Mekar Component
You can use independent version of component, by installing each component


## Installation
For example for Button, install the component via NPM
